  ...
  socket.on('generate-draft-order', (draftConfig) => {
    try {
      ...
      if (draftConfig.manualDraftOrder && Array.isArray(draftConfig.manualDraftOrder)) {
        ...
        draftOrder = generateDraftOrder(draftState.teams, draftConfig.draftType || 'snake');
      }
    ...
    try {
      ...
      if (!draftState.draftOrder.length) {
        if (draftConfig.manualDraftOrder && Array.isArray(draftConfig.manualDraftOrder)) {
          ...
          draftState.draftOrder = generateDraftOrder(draftState.teams, draftConfig.draftType || 'snake');
        }
      }
