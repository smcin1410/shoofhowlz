...
const Header = ({ socket, draftState, onReturnToLobby, isCommissioner, onAdminLogin, isMuted, setIsMuted }) => {
      ...
      <div className="container mx-auto px-4 py-2">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
          ...
          <div className="flex items-center justify-between sm:justify-start gap-3">
            ...
            {draftState?.isDraftStarted && onReturnToLobby && (
              <button
                onClick={() => {
            ...
            {/* Admin Button */}
            {draftState?.adminPassword && !isCommissioner && (
              <button
